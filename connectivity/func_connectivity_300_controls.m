...
for iSess=1:length(session_list)
   ...
   for iCond=1:4
    ...
    load([main_dir,'/results/func_networks/', roi, '_controles/', sessionName,'/cond', num2str(iCond),'/func_roi.mat'])
...
save([main_dir, '/results/connectivity/300_controles/connectivity_300.mat'], 'C')
save([main_dir, '/results/connectivity/300_controles/connectivity.mat'], 'C_net')
save([main_dir, '/results/connectivity/300_controles/intra_connectivity.mat'], 'C_intra')
save([main_dir, '/results/connectivity/300_controles/inter_connectivity.mat'], 'C_inter')

C_net_2 = zeros(4, 4, n_nets, n_nets);
for iSess=1:10
    for iCond=1:4
        for i=1:n_nets
            for j=1:n_nets
...
save([main_dir, '/results/connectivity/300_controles/connectivity_2.mat'], 'C_net_2')
